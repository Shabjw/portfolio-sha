...
function ObservatorySky({ glow }: { glow: { x: number; y: number } }) {
  ...
  return (
    <>
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_16%_15%,rgba(255,185,107,.64),transparent_25rem),radial-gradient(circle_at_77%_11%,rgba(220,178,208,.34),transparent_29rem),radial-gradient(circle_at_58%_56%,rgba(151,179,204,.58),transparent_38rem),linear-gradient(135deg,#f2aa66_0%,#c99091_25%,#9bb8d1_56%,#416784_100%)]" />
      <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(255,244,224,.36),rgba(151,181,205,.12)_44%,rgba(54,88,118,.38))]" />
  ...
  return (
    ...
    >
      ...
      <div className="absolute right-[7%] top-[116px] z-40 w-60 rounded-[1.5rem] bg-[#f7e6cc]/92 p-4 text-[#2f251f] shadow-soft ring-1 ring-white/60 float-slow" style={{ "--r": "7deg" } as CSSProperties}>
        ...
        <p className="text-[10px] uppercase tracking-[0.24em] text-[#7f654f]">Based in Paris · open to Europe</p>
...
export function Hero() {
  ...
  return (
    <section
      id="top"
      className="relative min-h-[calc(100svh-4rem)] overflow-hidden bg-[#7899b5] text-white"
      onMouseMove={onMove}
      onMouseLeave={() => {
        setTilt({ x: 0, y: 0 });
        setGlow({ x: 50, y: 38 });
